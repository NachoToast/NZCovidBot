...
const invite: Command = {
    execute: async ({ message }: { message: Message }) => {
        message.channel.send(
            devMode
                ? '<https://discord.com/api/oauth2/authorize?client_id=878842220755697756&permissions=8&scope=bot>'
                : '<https://discord.com/api/oauth2/authorize?client_id=878841453328085032&permissions=8&scope=bot>'
        );
    },
